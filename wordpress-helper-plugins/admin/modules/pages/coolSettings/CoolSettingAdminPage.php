...
namespace Elhelper\admin\modules\pages\coolSettings;


use Elhelper\common\Controller;

class CoolSettingAdminPage extends Controller {
	...
	public function __construct() {
		...
		add_action( 'admin_menu', [ $this, 'my_cool_plugin_create_menu' ] );
	...
	function my_cool_plugin_create_menu() {
		...
		add_menu_page( 'My Cool Plugin Settings', 'Cool Settings', 'administrator', __FILE__, [
			$this,
