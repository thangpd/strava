...
module.exports = {
    ...
    files: [
        {
            ...
            entry: {
                ...
                stravaapiModel: ['./modules/stravaApiModule/assets/index.js'],
                stravaApiShortcode: ['./shortcode/stravaApi/assets/index.js'],
                stravaApiGetAccessShortcode: ['./shortcode/stravaGetAccessToken/assets'],
                stravaApiSettingPage: ['./admin/modules/pages/stravaApiSettingPages/assets/index.js'],
    ...
    watch: ['./inc|includes/**/*.php', '*.scss', './shortcode/**/*.scss', '*.js', '*.jsx'],
